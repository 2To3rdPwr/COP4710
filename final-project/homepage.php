                    ...
                    <div id="login" class = "edit-info">   
                        ...
                        <form id = "myForm" action="includes/createevent.inc.php" method="post">
                            ...
                            <?php
                                ...
                                if(strpos($fullurl, "error=eventlocationoccupied") == true)
                                {
                                    echo '<p id="error" style="color: red">Location is taken at this time</p>';
                                }
                                else if(strpos($fullurl, "error=notRSOadmin") == true)
                                {
                                    echo '<p id="error" style="color: red">You are not an admin of this RSO</p>';
                                }
                            ?>
